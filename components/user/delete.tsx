...
function DeleteSubmitButton({
    ...
    return (
        <button
            type="submit"
            disabled={pending}
            className="inline-flex items-center justify-center rounded-lg p-2 text-red-600 transition hover:bg-green-50 hover:text-red-700 disabled:cursor-not-allowed disabled:opacity-60"
            title={title ?? 'Delete'}
        >
